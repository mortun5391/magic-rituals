package com.mortun.magicrituals;
...
public class MagicRituals {
    ...
    public MagicRituals(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (MagicRituals) to respond directly to events.
